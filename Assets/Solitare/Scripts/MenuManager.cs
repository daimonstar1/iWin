...
public class MenuManager : MonoBehaviour {
	...
	void Start()
	{
		...
		Screen.autorotateToLandscapeLeft = true;//	Allow auto-rotation to landscape left?
		Screen.autorotateToLandscapeRight = true; //	Allow auto-rotation to landscape right?
		Screen.autorotateToPortrait = true; //	Allow auto-rotation to portrait?
		Screen.autorotateToPortraitUpsideDown = true; //	Allow auto-rotation to portrait, upside down?
*/
