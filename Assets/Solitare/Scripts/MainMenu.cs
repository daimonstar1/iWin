...
public class MainMenu : DefaultMenu
{
    ...
    if (w > h) {
      /*float ar = Util.Round(w / h,2);
			...
			if( is43 )
			{
				...
				string atlasName = "Sprites/4.3_ui";
				string atlasName2 = "Sprites/4.3_ui2";

				replaceSpriteInAtlas("Logo_Image",atlasName, "4.3_ui_logoL");
				replaceSpriteInAtlas("Play_Button",atlasName, "4.3_ui_buttonL");
				replaceSpriteInAtlas("Config_Button",atlasName, "4.3_ui_config_buttonP");
				replaceSpriteInAtlas("FB_Button",atlasName, "4.3_ui_fb_buttonL");
				replaceSpriteInAtlas("PromoBG_Image",atlasName, "4.3_ui_promo_barL");
				replaceSpriteInAtlas("PromoFlare_Image",atlasName, "4.3_ui_promo_flareL");
				replaceSpriteInAtlas("PromoMCG_Image",atlasName, "4.3_ui_promo_MCGL");
				replaceSpriteInAtlas("PromoIconBTFC_Button",atlasName, "4.3_ui_icon_BTFCL");
				replaceSpriteInAtlas("PromoIconJQFC_Button",atlasName, "4.3_ui_icon_JQFCL");
				replaceSpriteInAtlas("PromoIconCFC_Button",atlasName, "4.3_ui_icon_CFCL");

				replaceSpriteInAtlas("Dialog_Image",atlasName2, "4.3_ui2_dialogboxL");
				replaceToggleSpriteInAtlas("Sound_Toggle",atlasName, "4.3_ui_checkbox_onL", "4.3_ui_checkbox_offL");
				//replaceSpriteInAtlas("Close_Button", atlasName, "4.3_ui_close_buttonL");

				//replaceSpriteInAtlas("RateDialog_Image",atlasName2, "4.3_ui2_rateboxL");
				//replaceSpriteInAtlas("RateClose_Button",atlasName, "4.3_ui_close_rate_buttonL");
				replaceSpriteInAtlas("RateNow_Button",atlasName, "4.3_ui_ratenow_buttonL");
			}
			else
			{
				// === Landscape 16:9 ===
				...
				string atlasName = "Sprites/16.9_ui";
				string atlasName2 = "Sprites/16.9_ui2";

				replaceSpriteInAtlas("Logo_Image",atlasName, "16.9_ui_logoL");
				replaceSpriteInAtlas("Play_Button",atlasName, "16.9_ui_buttonL");
				replaceSpriteInAtlas("Config_Button",atlasName, "16.9_ui_config_buttonP");
				replaceSpriteInAtlas("FB_Button",atlasName, "16.9_ui_fb_buttonL");
				replaceSpriteInAtlas("PromoBG_Image",atlasName, "16.9_ui_promo_barL");
				replaceSpriteInAtlas("PromoFlare_Image",atlasName, "16.9_ui_promo_flareL");
				replaceSpriteInAtlas("PromoMCG_Image",atlasName, "16.9_ui_promo_MCGL");
				replaceSpriteInAtlas("PromoIconBTFC_Button",atlasName, "16.9_ui_icon_BTFCL");
				replaceSpriteInAtlas("PromoIconJQFC_Button",atlasName, "16.9_ui_icon_JQFCL");
				replaceSpriteInAtlas("PromoIconCFC_Button",atlasName, "16.9_ui_icon_CFCL");

				replaceSpriteInAtlas("Dialog_Image",atlasName2, "16.9_ui2_dialogboxL");
				replaceToggleSpriteInAtlas("Sound_Toggle",atlasName, "16.9_ui_checkbox_onL", "16.9_ui_checkbox_offL");
				//replaceSpriteInAtlas("Close_Button", atlasName, "16.9_ui_close_buttonL");

				//replaceSpriteInAtlas("RateDialog_Image",atlasName2, "16.9_ui2_rateboxL");
				//replaceSpriteInAtlas("RateClose_Button",atlasName, "16.9_ui_close_rate_buttonL");
				replaceSpriteInAtlas("RateNow_Button",atlasName, "16.9_ui_ratenow_buttonL");
			}*/
    } else {
      ...
      if (is43) {
        ...
        /*string atlasName = "Sprites/4.3_ui";
				...
				replaceSpriteInAtlas("Logo_Image",atlasName, "4.3_ui_logoP");
				replaceSpriteInAtlas("Play_Button",atlasName, "4.3_ui_buttonP");
				replaceSpriteInAtlas("Config_Button",atlasName, "4.3_ui_config_buttonP");
				replaceSpriteInAtlas("FB_Button",atlasName, "4.3_ui_fb_buttonL");
				replaceSpriteInAtlas("PromoBG_Image",atlasName, "4.3_ui_promo_barL");
				replaceSpriteInAtlas("PromoFlare_Image",atlasName, "4.3_ui_promo_flareL");
        ...
        /*string atlasName = "Sprites/16.9_ui";
				...
				replaceSpriteInAtlas("Logo_Image",atlasName, "16.9_ui_logoP");
				replaceSpriteInAtlas("Play_Button",atlasName, "16.9_ui_buttonP");
				replaceSpriteInAtlas("Config_Button",atlasName, "16.9_ui_config_buttonP");
				replaceSpriteInAtlas("FB_Button",atlasName, "16.9_ui_fb_buttonL");
				replaceSpriteInAtlas("PromoBG_Image",atlasName, "16.9_ui_promo_barL");
				replaceSpriteInAtlas("PromoFlare_Image",atlasName, "16.9_ui_promo_flareL");
  ...
  public override void OnButtonClick (Button bt)
  {
    ...
    case "FBInvite2_Button":
      {
        /*FB.Mobile.AppInvite(
						new Uri(FBAppLink_URL),
						new Uri(FBImageLink_URL),
						this.AppInviteCallback
					);*/
        break;
      }
    case "FBLike_Button":
  ...
  /*private void AppInviteCallback(Facebook.Unity.IAppInviteResult result) {
		if (result == null) {
			Debug.Log("Error - result is null");
			return;
		}
